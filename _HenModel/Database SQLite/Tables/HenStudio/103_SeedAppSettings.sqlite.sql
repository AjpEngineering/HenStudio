-- --------------------------------------------------------------------------------
--  SCRIPT: 103_SeedAppSettings
--  File  : 103_SeedAppSettings.sqlite.sql
-- --------------------------------------------------------------------------------
--  Description: 
--    Script to seed the AppSettings Table.
-- --------------------------------------------------------------------------------
--    AppSettings includes fields for ...
--      + App Setting Id (PK) ... INTEGER
--      + App Setting Name ...... TEXT
--      + App Setting Value ..... TEXT
-- ================================================================================
-- 
-- !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
--                                                                               !!
