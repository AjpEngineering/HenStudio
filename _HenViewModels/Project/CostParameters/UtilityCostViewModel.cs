...
//=====================================================================================================================
//  DESCRIPTION: 
//    This file contains the view model class for the Utility Cost Project-Cost Parameters View Model.
//=====================================================================================================================
//  AUTHOR:
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//                                                                                                                   !!
...
namespace HenViewModel.Project.CostParameters
{
    ...
    public class UtilityCostViewModel : ViewModelBase
    {
        ...
        /// </summary>
        /// <param name="utilityCostDto">The utility cost data to add.</param>
        ...
        public Guid AddUtilityCost(UtilityCostDto utilityCostDto)
        {
            ...
            try
            {
                ...
                //-------------------------------------------------
                internalUtilityCostDto.Id = utilityCostDto.Id;
                internalUtilityCostDto.ProjectId = utilityCostDto.ProjectId;

                internalUtilityCostDto.HP_SteamCost_Metric      = utilityCostDto.HP_SteamCost_Metric;
                internalUtilityCostDto.MP_SteamCost_Metric      = utilityCostDto.MP_SteamCost_Metric;
                internalUtilityCostDto.LP_SteamCost_Metric      = utilityCostDto.LP_SteamCost_Metric;
                internalUtilityCostDto.CoolingWaterCost_Metric  = utilityCostDto.CoolingWaterCost_Metric;
                internalUtilityCostDto.ChilledWaterCost_Metric  = utilityCostDto.ChilledWaterCost_Metric;
                internalUtilityCostDto.FuelGasCost_Metric       = utilityCostDto.FuelGasCost_Metric;

                internalUtilityCostDto.HP_SteamCost_English     = utilityCostDto.HP_SteamCost_English;
                internalUtilityCostDto.MP_SteamCost_English     = utilityCostDto.MP_SteamCost_English;
                internalUtilityCostDto.LP_SteamCost_English     = utilityCostDto.LP_SteamCost_English;
                internalUtilityCostDto.CoolingWaterCost_English = utilityCostDto.CoolingWaterCost_English;
                internalUtilityCostDto.ChilledWaterCost_English = utilityCostDto.ChilledWaterCost_English;
                internalUtilityCostDto.FuelGasCost_English      = utilityCostDto.FuelGasCost_English;

                internalUtilityCostDto.DutyUnits_Metric         = utilityCostDto.DutyUnits_Metric;
                internalUtilityCostDto.DutyUnits_English        = utilityCostDto.DutyUnits_English;
                //-------------------------------------------------------------------------------------
        ...
        /// <summary>
        /// Updates (UPDATE) an existing utility cost in the database using the specified utility cost data transfer object (DTO) 
        /// with external units.
        /// </summary>
