...
--  File : UtilityStreams.sqlite.sql
-- --------------------------------------------------------------------------------
--  Description: 
...
CREATE TABLE UtilityStreams (
	...
	StreamCategory        TEXT NOT NULL DEFAULT 'Utility',
	StreamHeat            TEXT NOT NULL DEFAULT 'Latent',
	StreamId              TEXT NOT NULL,
	Name                  TEXT NOT NULL,
	UtilityType           TEXT NOT NULL DEFAULT 'Cold Water',
	...
	CONSTRAINT CK_UtilityStreams_StreamCategory CHECK (StreamCategory IN ('Process', 'Utility')),
	CONSTRAINT CK_UtilityStreams_StreamHeat CHECK (StreamHeat IN ('Sensible', 'Latent')),
