#region HEADER
//#####################################################################################################################
//#################################  T a r g e t s C a l c u l a t e D a t a . c s  ###################################
//#####################################################################################################################
//  FILENAME:  TargetsCalculateData.cs
//  NAMESPACE: PinchData
//  CLASS(S):  TargetsCalculateData
//  COMPONENT: _PinchData.dll
//=====================================================================================================================
//  DESCRIPTION: 
//    This file contains the code for the Targets Calculate Data class.
//    This class contains all the data associated with the TARGETS Calculate Panel
//=====================================================================================================================
//  AUTHOR:
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//                                                                                                                   !!
...
namespace PinchData
{
    #region class TargetsCalculateData
    /// <summary>
    /// This class contains all the data associated with the TARGETS Calculate Panel
    /// </summary>
    public class TargetsCalculateData : ABC_JsonFileData
    {
        #region CONSTANTS
        const string NAMESPACE = "PinchData";
        const string CLASS = "TargetsCalculateData";
        #endregion      // CONSTANTS
        ...
        /// Default Constructor
        /// </summary>        
        public TargetsCalculateData()
        {
            string strMethod = "CTOR";
            PinchLogger.WriteSeparatorLine('>');
            PinchLogger.LogInfo(NAMESPACE, CLASS, strMethod, "Creating TargetsCalculateData Object");
            try
            {
                //----------------------------------------
            ...
            {
                PinchLogger.LogInfo(NAMESPACE, CLASS, strMethod, "TargetsCalculateData Object CREATED");
                PinchLogger.WriteSeparatorLine('<');
            }
        }
        #endregion  // CTOR
    ...
    #endregion  // class TargetsCalculateData
}
