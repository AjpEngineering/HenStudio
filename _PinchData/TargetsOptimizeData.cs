#region HEADER
//#####################################################################################################################
//##################################  T a r g e t s O p t i m i z e D a t a . c s  ####################################
//#####################################################################################################################
//  FILENAME:  TargetsOptimizeData.cs
//  NAMESPACE: PinchData
//  CLASS(S):  TargetsOptimizeData
//  COMPONENT: _PinchData.dll
//=====================================================================================================================
//  DESCRIPTION: 
//    This file contains the code for the Targets Optimize Data class.
...
namespace PinchData
{
    #region class TargetsOptimizeData
    /// <summary>
    /// This class contains all the data associated with the TARGETS Optimize Panel
    /// </summary>
    public class TargetsOptimizeData : ABC_JsonFileData
    {
        ...
        const string CLASS = "TargetsOptimizeData";
        #endregion      // CONSTANTS
        ...
        /// Default Constructor
        /// </summary>        
        public TargetsOptimizeData()
        {
            string strMethod = "CTOR";
            PinchLogger.WriteSeparatorLine('>');
            PinchLogger.LogInfo(NAMESPACE, CLASS, strMethod, "Creating TargetsOptimizeData Object");
            try
            {
                //----------------------------------------
    ...
    #endregion  // class TargetsOptimizeData
}
