#region HEADER
//#####################################################################################################################
//#################################  T a r g e t s C o m p o s i t e D a t a . c s  ###################################
//#####################################################################################################################
//  FILENAME:  TargetsCompositeData.cs
//  NAMESPACE: PinchData
//  CLASS(S):  TargetsCompositeData
//  COMPONENT: _PinchData.dll
//=====================================================================================================================
//  DESCRIPTION: 
//    This file contains the code for the Targets Composite Data class.
//    This class contains all the data associated with the TARGETS Composite Panel
//=====================================================================================================================
//  AUTHOR:
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//                                                                                                                   !!
...
namespace PinchData
{
    #region class TargetsCompositeData
    /// <summary>
    /// This class contains all the data associated with the TARGETS Composite Panel
    /// </summary>
    public class TargetsCompositeData : ABC_JsonFileData
    {
        #region CONSTANTS
        const string NAMESPACE = "PinchData";
        const string CLASS = "TargetsCompositeData";
        #endregion      // CONSTANTS
        ...
        /// Default Constructor
        /// </summary>        
        public TargetsCompositeData()
        {
            string strMethod = "CTOR";
            PinchLogger.WriteSeparatorLine('>');
            PinchLogger.LogInfo(NAMESPACE, CLASS, strMethod, "Creating TargetsCompositeData Object");
            try
            {
                //----------------------------------------
            ...
            {
                PinchLogger.LogInfo(NAMESPACE, CLASS, strMethod, "TargetsCompositeData Object CREATED");
                PinchLogger.WriteSeparatorLine('<');
            }
        }
        #endregion  // CTOR
    ...
    #endregion  // class TargetsCompositeData
}
