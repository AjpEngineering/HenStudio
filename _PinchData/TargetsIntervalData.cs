#region HEADER
//#####################################################################################################################
//##################################  T a r g e t s I n t e r v a l D a t a . c s  ####################################
//#####################################################################################################################
//  FILENAME:  TargetsIntervalData.cs
//  NAMESPACE: PinchData
//  CLASS(S):  TargetsIntervalData
//  COMPONENT: _PinchData.dll
//=====================================================================================================================
//  DESCRIPTION: 
//    This file contains the code for the Targets Interval Data class.
//    This class contains all the data associated with the TARGETS Interval Panel
//=====================================================================================================================
//  AUTHOR:
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//                                                                                                                   !!
...
namespace PinchData
{
    #region class TargetsIntervalData
    /// <summary>
    /// This class contains all the data associated with the TARGETS Interval Panel
    /// </summary>
    public class TargetsIntervalData : ABC_JsonFileData
    {
        #region CONSTANTS
        const string NAMESPACE = "PinchData";
        const string CLASS = "TargetsIntervalData";
        #endregion      // CONSTANTS
        ...
        /// Default Constructor
        /// </summary>        
        public TargetsIntervalData()
        {
            string strMethod = "CTOR";
            PinchLogger.WriteSeparatorLine('>');
            PinchLogger.LogInfo(NAMESPACE, CLASS, strMethod, "Creating TargetsIntervalData Object");
            try
            {
                //----------------------------------------
            ...
            {
                PinchLogger.LogInfo(NAMESPACE, CLASS, strMethod, "TargetsIntervalData Object CREATED");
                PinchLogger.WriteSeparatorLine('<');
            }
        }
        #endregion  // CTOR
    ...
    #endregion  // class TargetsIntervalData
}
