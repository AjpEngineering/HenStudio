#region HEADER
//#####################################################################################################################
//##################################  I n p u t V a l i d a t i o n D a t a . c s  ####################################
//#####################################################################################################################
//  FILENAME:  InputValidationData.cs
//  NAMESPACE: PinchData
//  CLASS(S):  InputValidationData
//  COMPONENT: _PinchData.dll
//=====================================================================================================================
//  DESCRIPTION: 
//    This file contains the code for the Input Validation Data class.
//    This class contains all the data associated with the INPUT Validation Panel
//=====================================================================================================================
//  AUTHOR:
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//                                                                                                                   !!
...
namespace PinchData
{
    ...
    /// This class contains all the data associated with the INPUT Validation Panel
    /// </summary>
    public class InputValidationData : ABC_JsonFileData
    {
        #region CONSTANTS
        const string NAMESPACE = "PinchData";
        const string CLASS = "InputValidationData";
        #endregion      // CONSTANTS
        ...
        public InputValidationData()
        {
            ...
            PinchLogger.LogInfo(NAMESPACE, CLASS, strMethod, "Creating InputValidationData Object");
            try
            {
                //----------------------------------------
            ...
            {
                PinchLogger.LogInfo(NAMESPACE, CLASS, strMethod, "InputValidationData Object CREATED");
                PinchLogger.WriteSeparatorLine('<');
            }
        }
        #endregion  // CTOR
    ...
    #endregion  // class InputValidationData
}
