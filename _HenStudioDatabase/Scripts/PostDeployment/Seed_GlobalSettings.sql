...
USING (VALUES
    ...
    ('InternalUnitsA', 'm2', 'string', 'INTERNAL Heat Exchanger Area Units'),
    ...
    ('InternalUnitsU', 'kW/(m2·K)', 'string', 'INTERNAL Default Heat Transfer Coefficient Units'),
    ...
    ('ExternalTempUnits', 'degF', 'string', 'EXTERNAL Default Temperature Units'),
    ('ExternalPressUnits', 'psia', 'string', 'EXTERNAL Default Pressure Units'),
    ('ExternalUnitsA', 'm2', 'string', 'EXTERNAL Default Heat Exchanger Area Units'),
    ...
    ('ExternalUnitsHeatCapacityFlowRate', 'MMBtu/(hr·degF)', 'string', 'EXTERNAL Default CP Units'),
    ('ExternalUnitsU', 'MMBtu/(hr·ft2·degF)', 'string', 'EXTERNAL Default Heat Transfer Coefficient Units'),
    ...
    ('DefaultEnglishU', '35.2', 'double', 'Default English Heat Transfer Coefficient - Btu/(hr·ft2·degF) value'),
    ('DefaultMetricU', '720.0', 'double', 'Default Metric Heat Transfer Coefficient - kJ/(hr·m2·degC) value'),
